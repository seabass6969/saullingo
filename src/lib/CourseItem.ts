...
export const courseItemVersion = "v3.1.beta";
		...
		ListQuestion: [
			{
				index: 0,
				question:
					"Which of the following is the correct Subject Object Verb order for <ipa>hɛɾɪnəʊ</ipa>?",
			...
			},
			{
				index: 2,
				question:
					"Reorder the words in the sentence “The man walked” as if it were written in <ipa>hɛɾɪnəʊ</ipa>:",
			...
			},
			{
				index: 3,
				question:
					"Reorder the words in the sentence “Kynan can swim and he is good” as if it were written in <ipa>hɛɾɪnəʊ</ipa>:",
				Type: questionTypes.ReorderQuestion,
			...
			},
			{
				index: 4,
				question:
					"Rewrite the following sentence as if it were written in <ipa>hɛɾɪnəʊ</ipa>. “Mimiër likes eating bread but she hates mushrooms”",
		...
		ListQuestion: [
			{
				index: 0,
				question:
					"Which of the following is the correct ending for the past tense?",
			...
			},
			{
				...
				answer: [
					["neɪ", "neɪ", "neɪ", "ni", "neɪ"],
					["miʃʌ", "miʃi", "miʃi", "miʃi", "miʃʌ"],
					["ɹɒzæ", "ɹɒzi", "ɹɒzə", "ɹɒzeɪ", "ɹɒzə"],
				],
				MatchQuestion: [
					["neɪ", undefined, "neɪ", undefined, undefined],
					[undefined, "miʃi", undefined, "miʃi", undefined],
					[undefined, undefined, "ɹɒzə", undefined, "ɹɒzə"],
				],
				TopTable: [
					"",
					"Past",
...
export const courseFlashcard: Flashcard[] = [
	{
		...
		listFlashcard: [
			...
			{
				lessonBasedOn: 1,
				front: "What is the verb ending for the past tense?",
				back: "“eɪ” (ay)",
			},
			{
				lessonBasedOn: 1,
				front: "What is the verb ending for the present tense?",
				back: '"i" (ee)',
			},
			{
				lessonBasedOn: 1,
				front: "What is the verb ending for the future tense?",
				back: "“əʊ” (owe) ",
			},
			{
				lessonBasedOn: 1,
				front: "What is the verb ending for the infinitive tense?",
				back: '"i" (ee)',
			},
			{
				lessonBasedOn: 1,
				front: "What is the verb ending for the gnomic tense?",
				back: "“eə” (air)",
			},
		],
	},
